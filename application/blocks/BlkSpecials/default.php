<div class="box">
        ...
        <div class="box-content">
          <div class="box-product">
            <div>
              <div class="image"><a href="product.html"><img src="<?php echo $view->ImageURL;?>/product/apple_cinema_30-60x60.jpg" alt="Apple Tablet Retina" /></a></div>
            ...
            <div>
              <div class="image"><a href="product.html"><img src="<?php echo $view->ImageURL;?>/product/canon_eos_5d_1-60x60.jpg" alt="Canon Digital Camera" /></a></div>
