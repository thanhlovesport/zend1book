...
<body id="minwidth-body">
	...
	<div id="border-top" class="h_green">
		<div>
			<div>
				<span class="version">Version 1.0 Alpha</span> <span class="title"
					style="padding-left: 20px">Seahog cms</span>
			</div>
		</div>
	</div>
	<div id="header-box">
		...
		<div id="module-menu">
			...
			<ul class="menuTiny" id="menuTiny">
				<li><a href="#" class="menuTinyLink">Main</a>
					<ul>
						<li><a
							href="<?php echo $this->baseUrl('/default/index/index/');?>">Front
								End</a></li>
						<li><a
							href="<?php echo $this->baseUrl('/default/admin/index/');?>">Back
								End</a></li>
				...
				<li><a href="#" class="menuTinyLink">Member</a>
					<ul>
						<li><a
							href="<?php echo $this->baseUrl('/default/admin-group/index/');?>">Group
								manager</a></li>
						<li><a
							href="<?php echo $this->baseUrl('/default/admin-user/index/');?>">User
								manager</a></li>
						<li><a
							href="<?php echo $this->baseUrl('/default/admin-permission/index/');?>">Permission</a></li>
					</ul></li>
				<li><a href="#" class="menuTinyLink">Products</a>
					<ul>
						<li><a
